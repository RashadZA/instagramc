...
const mobileBackgroundColor = Colors.white10;
...
const Color gradientStartColor = Colors.blueAccent;
Color gradientCenterColor = gradientStartColor.withOpacity(0.5);
const Color gradientEndColor = Colors.white38;

Color primaryShadowColor = primaryColor.withOpacity(0.4);
