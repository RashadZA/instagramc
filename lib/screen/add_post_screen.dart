            ...
            appBar: AppBar(
              ...
              actions: <Widget>[
                TextButton(
                  onPressed: () => postImage(
                    bContext: context,
                    uid: userProvider.getUserModel.uid ?? "",
                    username: userProvider.getUserModel.userName ?? "",
                    profImage: userProvider.getUserModel.userImageURL ?? "",
                  ),
                  child: const Text(
                    "Post",
                    style: TextStyle(
                  ...
                  children: <Widget>[
                    CircleAvatar(
                      backgroundImage: NetworkImage(
                        userProvider.getUserModel.userImageURL ?? "",
                      ),
                    ),
                    SizedBox(
